            ...
            <div class="box">
              <div align="left">
                 ...
                 <table  class="tbl-list"  id="lst-submit-url">
					...
					<td align="center" width="10px">Lenght</td>		
					<td align="center">Ref Code</td>			
				    <td align="center">Status</td>
                    </tr>
                    {section name=i loop=$all_coupon}
                    <tr>                       
                                 
                        <td align="center">{$all_coupon[i].code}</td>
                        <td align="center">{$all_coupon[i].start_date}</td>                    	
						<td align="center">{$all_coupon[i].end_date}</td>
						<td align="center">{$all_coupon[i].percent}</td>	
						<td align="center">{$all_coupon[i].length}</td>
						<td align="center">{$all_coupon[i].ref_code}</td>					
						<td>{if $all_coupon[i].status == '0'} Pending <a href="?confirm={$all_coupon[i].coupon_id}&type=yes" class="smart-btn btn-openfrm btn-pay-atm-conf-yes">Active now</a>{else} Actived 	<a href="?confirm={$all_coupon[i].coupon_id}&type=no" class="smart-btn btn-openfrm btn-pay-atm-conf-no">inactive</a>{/if} <a href="?confirm={$all_coupon[i].coupon_id}&type=delete" class="smart-btn btn-openfrm btn-pay-atm-conf-yes">Del</a></td>	                          					
                    </tr>           
                    ...
                    {/section}
				  	...
				  	<tr>                               
                        ...
                        <td align="center"><input type="text" id="start_date" name="start_date" class="date-picker">						
						<div class="popup-calendar-wrapper"><div class="popup-calendar" style="display: none;"></div></div></td>                    	
						<td align="center"><div class="date-picker-holder"><input type="text" id="end_date" name="end_date" class="date-picker"><div class="popup-calendar-wrapper"><div class="popup-calendar" style="display: none;"></div></div></div></td>
						<td align="center"><input style="width:35px" type="text" name="percent" /></td>	
						<td align="center"><input style="width:35px" type="text" name="length" /></td>		
						<td align="center"><input style="width:55px" type="text" name="ref_code" /></td>				
