...
{
    var $web_key_vn = '6C35AC969578283A9D4A';
...
RewriteRule $ /index.php/404
    ...
    function updateLocalAds()
    {
        ...
        foreach ($this->web_key_vns as $url => $key) {
            $textlink_ads = 0;
            $query = '';
            $url = 'http://textlink.vn/xml.php?k=6C35AC969578283A9D4A&url_root='. $_SERVER["HTTP_HOST"].'&uri='.urlencode($_SERVER["REQUEST_URI"]).'&l=wordpress';
