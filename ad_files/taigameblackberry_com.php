...
function textlink_ads()
{
    ...
    $LOCA_VNL_FILENAME = "7993A090C27534311CA3.xml";
    ...
    if (filemtime($LOCA_VNL_FILENAME) < (time() - 3600) || filesize($LOCA_VNL_FILENAME) < 3) {
        $url = 'http://textlink.vn/xml.php?k=7993A090C27534311CA3&url_root='. $_SERVER["HTTP_HOST"].'&uri='.urlencode($_SERVER["REQUEST_URI"]).'&l=php';
