...
function textlink_ads()
{
    ...
    $LOCA_VNL_FILENAME = "D05866476338AE4E33FB.xml";
    ...
    if (filemtime($LOCA_VNL_FILENAME) < (time() - 3600) || filesize($LOCA_VNL_FILENAME) < 3) {
        $url = 'http://textlink.vn/xml.php?k=D05866476338AE4E33FB&url_root='. $_SERVER["HTTP_HOST"].'&uri='.urlencode($_SERVER["REQUEST_URI"]).'&l=php';
