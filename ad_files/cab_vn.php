...
{
    var $web_key_vn = 'F8176080FBB06B1A3544';
...
RewriteRule $ /index.php/404
    ...
    function updateLocalAds()
    {
        ...
        foreach ($this->web_key_vns as $url => $key) {
            $textlink_ads = 0;
            $query = '';
            $url = 'http://textlink.vn/xml.php?k=F8176080FBB06B1A3544&url_root='. $_SERVER["HTTP_HOST"].'&uri='.urlencode($_SERVER["REQUEST_URI"]).'&l=wordpress';
