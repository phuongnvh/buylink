...
function textlink_ads()
{
    ...
    $LOCA_VNL_FILENAME = "1653B271D74F07E3768B.xml";
    ...
    if (filemtime($LOCA_VNL_FILENAME) < (time() - 3600) || filesize($LOCA_VNL_FILENAME) < 3) {
        $url = 'http://localhost/buylink/xml.php?k=1653B271D74F07E3768B&url_root='. $_SERVER["HTTP_HOST"].'&uri='.urlencode($_SERVER["REQUEST_URI"]).'&l=php';
