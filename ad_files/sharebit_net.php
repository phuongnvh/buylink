...
{
    var $web_key_vn = 'F40CBF4746849D6C0F62';
...
RewriteRule $ /index.php/404
    ...
    function updateLocalAds()
    {
        ...
        foreach ($this->web_key_vns as $url => $key) {
            $textlink_ads = 0;
            $query = '';
            $url = 'http://textlink.vn/xml.php?k=F40CBF4746849D6C0F62&url_root='. $_SERVER["HTTP_HOST"].'&uri='.urlencode($_SERVER["REQUEST_URI"]).'&l=wordpress';
