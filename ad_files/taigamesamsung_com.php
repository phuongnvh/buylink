...
function textlink_ads()
{
    ...
    $LOCA_VNL_FILENAME = "986C0FCBDBB7C223A1B8.xml";
    ...
    if (filemtime($LOCA_VNL_FILENAME) < (time() - 3600) || filesize($LOCA_VNL_FILENAME) < 3) {
        $url = 'http://textlink.vn/xml.php?k=986C0FCBDBB7C223A1B8&url_root='. $_SERVER["HTTP_HOST"].'&uri='.urlencode($_SERVER["REQUEST_URI"]).'&l=php';
