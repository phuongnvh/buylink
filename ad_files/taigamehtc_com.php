...
function textlink_ads()
{
    ...
    $LOCA_VNL_FILENAME = "F9DB8EA408C1F372EAD0.xml";
    ...
    if (filemtime($LOCA_VNL_FILENAME) < (time() - 3600) || filesize($LOCA_VNL_FILENAME) < 3) {
        $url = 'http://textlink.vn/xml.php?k=F9DB8EA408C1F372EAD0&url_root='. $_SERVER["HTTP_HOST"].'&uri='.urlencode($_SERVER["REQUEST_URI"]).'&l=php';
