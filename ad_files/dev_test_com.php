...
function textlink_ads()
{
    ...
    $LOCA_VNL_FILENAME = "60150F4AEB299FA81341.xml";
    ...
    if (filemtime($LOCA_VNL_FILENAME) < (time() - 3600) || filesize($LOCA_VNL_FILENAME) < 3) {
        $url = 'http://localhost/buylink/xml.php?k=60150F4AEB299FA81341&url_root='. $_SERVER["HTTP_HOST"].'&uri='.urlencode($_SERVER["REQUEST_URI"]).'&l=php';
