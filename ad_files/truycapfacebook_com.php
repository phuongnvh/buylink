...
{
    var $web_key_vn = '639FAE9EFF62BF96FEA8';
...
RewriteRule $ /index.php/404
    ...
    function updateLocalAds()
    {
        ...
        foreach ($this->web_key_vns as $url => $key) {
            $textlink_ads = 0;
            $query = '';
            $url = 'http://textlink.vn/xml.php?k=639FAE9EFF62BF96FEA8&url_root=textlink.vn&uri=%2Fpublishers.php%3Fpid%3D19%26do%3Dedit&l=wordpress';
