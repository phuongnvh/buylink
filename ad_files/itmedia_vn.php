...
{
    var $web_key_vn = 'D5A7E1DB952D1D3CE85D';
...
RewriteRule $ /index.php/404
    ...
    function updateLocalAds()
    {
        ...
        foreach ($this->web_key_vns as $url => $key) {
            $textlink_ads = 0;
            $query = '';
            $url = 'http://textlink.vn/xml.php?k=D5A7E1DB952D1D3CE85D&url_root=localhost&uri=%2Fad%2Fpublishers.php%3Fpid%3D8%26do%3Dedit&l=wordpress';
